...
export const Navbar2 = (props: Navbar2Props) => {
  ...
  return (
    <nav className="flex fixed w-full items-center border-b border-border-primary bg-background-primary lg:min-h-18 lg:px-[5%]">
      ...
      {isDropdownOpen && (
        <AnimatePresence>
          ...
          <motion.nav
            ...
            transition={{ duration: 0.2 }}
            className="sm:bg-white dark:bg-gray-800 lg:absolute lg:z-50 lg:border lg:border-gray-300 dark:lg:border-gray-600 lg:p-2 lg:rounded-lg lg:shadow-lg lg:[--y-close:25%] transition-all duration-200 ease-in-out"
          >
            {navLink.subMenuLinks?.map((subMenuLink, index) => (
              <Link
                key={index}
