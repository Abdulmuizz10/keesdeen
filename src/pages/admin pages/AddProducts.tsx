...
const AddProducts: React.FC = () => {
  ...
  return (
    ...
    //             <label className="flex flex-col items-center justify-center w-full py-3 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
    //               <div className="flex flex-col items-center justify-center pt-5 pb-6">
    //                 <svg
    //                   className="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400"
    //                   aria-hidden="true"
    ...
    //             value={productCategory}
    //             onChange={(e) => setProductCategory(e.target.value)}
    //             className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-brand-neutral focus:border-border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
    //             required
    //           >
    //             <option value="">Select category</option>
    //             <option value="Men">Men</option>
    ...
    //             <option value="Footwear">Footwear</option>
    //           </select>
    //           {/* <Select onValueChange={setProductSubCategory}>
    //           <SelectTrigger className="rounded-md">
    //             <SelectValue placeholder="Select category" />
    //           </SelectTrigger>
    //           <SelectContent className=" bg-background-primary rounded-lg">
    ...
    //   </div>
    // </section>
    // <section className="px-4 py-16 md:py-24 lg:px-10 ">
    ...
    //             <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white dark:bg-gray-800 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-700">
    //               <div className="flex flex-col items-center justify-center pt-5 pb-6">
    //                 <svg
