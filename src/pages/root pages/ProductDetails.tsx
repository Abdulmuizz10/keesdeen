        ...
        <div className="container">
          <div className="flex gap-5 md:gap-10 flex-col lg:flex-row">
            ...
            <div className="flex-1 flex flex-col-reverse gap-3 sm:flex-row">
              <div className="flex sm:flex-col overflow-x-auto sm:overflow-y-scroll no-scrollbar">
                {product.imageUrls
                  ?.slice(1, 5)
...
const Animation = () => (
  <div className="w-full h-[110vh] flex items-center justify-center bg-white absolute top-0 left-0 right-0">
    <Spinner />
  </div>
);
